...
class Developer {
  ...
  const hecLaunchXDev = new LaunchXStudent("Hector", "js", ["elixir", "groovy", "lisp"])
  console.log(hecLaunchXDev)
  console.log(hecLaunchXDev.getName) // getter de la clase padre rehusada en la clase hija